		jQuery(document).ready(function() {
            ...
            if (this.title) {
                ...
                // Add view large button
                this.title += '<a href="'+this.element.data('fancybox-large')+'" >Go Large</a> ';
            } 
            else
            {
                // Add view large button
                this.title = '<a class="fancybox-item fancybox-view-large" href="'+this.element.data('fancybox-large')+'" title="View Large" target="_blank" ></a>';
          	}
        },
          helpers : {
            title : {
