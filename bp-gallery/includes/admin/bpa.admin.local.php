...
function bp_gallplus_admin() {
	...
	if ( isset( $_POST['submit'] )  ) {
        ...
        $bp_gallplus_max_priv3_images = get_site_option( 'bp_gallplus_max_priv3_images' );
	...
	<div class="wrap">
		...
		<h2><?php _e('BP Galleries Plus - ', 'bp-galleries-plus' ) ?> 1.1<?php _e(' - [Single Site Mode]', 'bp-galleries-plus' ) ?></h2>
		<br />
		...
		<form action="<?php echo site_url() . '/wp-admin/admin.php?page=bp-galleries-plus-settings' ?>" name="example-settings-form" id="example-settings-form" method="post">
			...
			<table class="form-table">  
					...
					<td>
						...
						<input type="radio" name="bp_gallplus_require_description" type="text" id="bp_gallplus_require_description"<?php if ($bp_gallplus_require_description == false) : ?> checked="checked"<?php endif; ?>  value="0" /> <?php _e( 'No', 'bp-galleries-plus' ) ?>
                                ...
                                <tr>
					<th scope="row"><?php _e('Allow site members to post comments on images', 'bp-galleries-plus' ) ?></th>
					<td>
						...
						<input type="radio" name="bp_gallplus_enable_comments" type="text" id="bp_gallplus_enable_comments"<?php if ($bp_gallplus_enable_comments == false) : ?> checked="checked"<?php endif; ?>  value="0" /> <?php _e( 'No', 'bp-galleries-plus' ) ?>
                                ...
                                <tr>
					<th scope="row"><?php _e('Disable public access to albums', 'bp-galleries-plus' ) ?></th>
					<td>
      ...
      <p>
	              ...
	              <tr>		
					...
					<td>
						<input name="bp_gallplus_max_priv2_images" type="text" id="bp_gallplus_max_priv2_images" value="<?php echo esc_attr( $bp_gallplus_max_priv2_images ); ?>" size="10" />
                                 ...
                                 <tr>
					<th scope="row"><label for="target_uri"><?php _e('Max images visible only to group members in each group album', 'bp-galleries-plus' ) ?></label></th>
					<td>
						<input name="bp_gallplus_max_priv3_images" type="text" id="bp_gallplus_max_priv3_images" value="<?php echo esc_attr( $bp_gallplus_max_priv3_images ); ?>" size="10" />
					</td>
				</tr>
                                <tr>
					<th scope="row"><label for="target_uri"><?php _e('Max images visible only to friends in a members album', 'bp-galleries-plus' ) ?></label></th>
					<td>
						<input name="bp_gallplus_max_priv4_images" type="text" id="bp_gallplus_max_priv4_images" value="<?php echo esc_attr( $bp_gallplus_max_priv4_images ); ?>" size="10" />
                                ...
                                <tr>
					<th scope="row"><label for="target_uri"><?php _e('Max private images in a members album', 'bp-galleries-plus' ) ?></label></th>
					<td>
			...
			<table class="form-table">
			    <tr valign="top">
					<th scope="row"><label for="target_uri"><?php _e('Maximum file size (mb) that can be uploaded', 'bp-galleries-plus' ) ?></label></th>
					<td>
